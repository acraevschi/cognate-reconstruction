        ...
        for rule in rules:
            ...
            current = tuple(
                LexicalForm(
                    ...
                    # Membership slices describe the observed source form and
                    # cannot be projected through arbitrary insertions or
                    # deletions without guessing. Original evidence remains
                    # intact in the context and trajectory.
                    cognate_memberships=(),
